 ...
 */
public abstract class AbstractTileBackground2 extends Background {
        
        /**
         * Serializable ID generated by Eclipse. If this class changes its
         * structure, this will be replaced with 2L.
         */
        private static final long serialVersionUID = 6418363022562998089L;
        ...
        private int horiz, vert, halfTileWidth, halfTileHeight;
         ...
         */
        public AbstractTileBackground2(int horiz, int vert, int tileWidth,
                int tileHeight) {
        ...
        public void render(Graphics2D g, int xbg, int ybg, int x, int y, int w, int h) {
                ...
                for (y1 = y - this.offsetY; y1 < y2; y1 += this.tileHeight) {
                        ...
                        for (x1 = x - this.offsetX; x1 < x2; x1 += this.tileWidth) {
                        	k++;
                        	if (k>=2){
                                this.renderTile(g, xTile, yTile, x1, y1+halfTileHeight);
                                k=0;
                        	}else this.renderTile(g, xTile, yTile, x1, y1);
        ...
        public Point getCoordinateAt(int tileX, int tileY) {
            this.point2.x = 0 + ((tileX - tileY) * this.halfTileWidth);
            this.point2.y = ((tileY + tileX) * this.halfTileHeight) + 0;
        ...
        protected void setTileSize(int tileWidth, int tileHeight) {
                this.tileWidth = tileWidth;
                this.tileHeight = tileHeight-halfTileHeight;
                super.setSize(this.horiz * this.getTileWidth(), this.vert
                        * this.getTileHeight()-halfTileHeight);
